...
+ (nullable NSArray *)tweetsFromCollectionAPIResponseDictionary:(NSDictionary *)dictionary
{
    ...
    NSDictionary *objects = [TWTRDictUtil dictForKey:@"objects" fromDict:dictionary];
    NSDictionary *tweetsDict = [TWTRDictUtil dictForKey:@"tweets" fromDict:objects];
    NSDictionary *usersDict = [TWTRDictUtil dictForKey:@"users" fromDict:objects];
    NSDictionary *response = [TWTRDictUtil dictForKey:@"response" fromDict:dictionary];
    NSArray *tweetsTimelineOrderMetadata = [TWTRDictUtil arrayForKey:@"timeline" fromDict:response];
...
+ (nullable NSMutableDictionary *)hyrdrateTweet:(nullable NSDictionary *)dictionary withUserFromUsers:(NSDictionary *)usersDict
{
    ...
    NSDictionary *strippedUserDetails = [TWTRDictUtil dictForKey:TWTRAPIConstantsStatusFieldUser fromDict:dictionary];
    NSString *authorID = [TWTRDictUtil stringForKey:TWTRAPIConstantsFieldIDString fromDict:strippedUserDetails];

    if (authorID) {
        NSDictionary *fullUserDetails = [TWTRDictUtil dictForKey:authorID fromDict:usersDict];
...
{
    NSDictionary *subTweet = [TWTRDictUtil objectForKey:key fromDict:tweet];
...
+ (nullable NSArray *)tweetsFromSearchAPIResponseDictionary:(NSDictionary *)dictionary
{
    ...
    NSArray *statusesArray = [TWTRDictUtil arrayForKey:@"statuses" fromDict:dictionary];
...
+ (nullable NSString *)minPositionFromCollectionAPIResponseDictionary:(NSDictionary *)collection
{
    ...
    NSDictionary *responseDict = [TWTRDictUtil dictForKey:@"response" fromDict:collection];
    NSDictionary *positionDict = [TWTRDictUtil dictForKey:@"position" fromDict:responseDict];
    NSString *minPosition = [TWTRDictUtil stringForKey:@"min_position" fromDict:positionDict];
...
+ (NSArray *)orderedTweetIDsFromCollectionOrderingResponse:(NSArray *)orderingResponse
{
    ...
    for (NSDictionary *tweetOrderingMetadata in orderingResponse) {
        NSDictionary *tweetDetails = [TWTRDictUtil dictForKey:@"tweet" fromDict:tweetOrderingMetadata];
        NSString *tweetID = [TWTRDictUtil stringForKey:@"id" fromDict:tweetDetails];
        if (tweetID) {
