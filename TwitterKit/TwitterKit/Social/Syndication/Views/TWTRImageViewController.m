...
- (void)viewDidAppear:(BOOL)animated
{
    ...
    [[Twitter sharedInstance].scribeSink didSeeMediaEntity:self.mediaEntity fromTweetID:self.parentTweetID];
}
...
{
    [[Twitter sharedInstance].imageLoader fetchImageWithURL:URL completion:^(UIImage *fullImage, NSError *error) {
        if (fullImage) {
