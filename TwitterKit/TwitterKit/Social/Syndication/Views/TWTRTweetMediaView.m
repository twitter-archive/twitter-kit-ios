    ...
    if ([tweet hasPlayableVideo]) {
        ...
        self.inlinePlayerView = [[TWTRVideoPlayerView alloc] initWithTweet:tweet
                                                     playbackConfiguration:[self videoPlaybackConfiguration]
                                                                scribeSink:[Twitter sharedInstance].scribeSink
...
{
    TWTRScribeSink *scribeSink = [Twitter sharedInstance].scribeSink;
    ...
    TWTRVideoViewController *viewController = [[TWTRVideoViewController alloc] initWithTweet:self.tweet
                                                                       playbackConfiguration:videoConfig
                                                                                  scribeSink:scribeSink
                                                                                previewImage:[self imageAtIndex:0]
                                                                                  playerView:self.inlinePlayerView];
