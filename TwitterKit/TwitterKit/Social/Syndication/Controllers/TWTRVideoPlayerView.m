...
- (instancetype)initWithTweet:(TWTRTweet *)tweet
        playbackConfiguration:(TWTRVideoPlaybackConfiguration *)playbackConfiguration
                   scribeSink:(nullable TWTRScribeSink *)scribeSink
                 controlsView:(nullable TWTRVideoControlsView *)controlsView
