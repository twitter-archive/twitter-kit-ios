...
{
    [[Twitter sharedInstance].scribeSink didNavigateInsideGallery];
}
...
{
    [[Twitter sharedInstance].scribeSink didPresentPhotoGallery];
}

- (void)didDismissInMediaContainer
{
    [[Twitter sharedInstance].scribeSink didDismissPhotoGallery];
}
