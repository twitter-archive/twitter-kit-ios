...
- (instancetype)initWithJSONDictionary:(NSDictionary *)dict
{
    ...
    if (self) {
        _displayUrl = [[TWTRDictUtil stringForKey:TWTRAPIConstantsStatusFieldUrlEntityDisplayUrl fromDict:dict] copy];
        _expandedUrl = [[TWTRDictUtil stringForKey:TWTRAPIConstantsStatusFieldUrlEntityExpandedUrl fromDict:dict] copy];
        _url = [[TWTRDictUtil stringForKey:TWTRAPIConstantsStatusFieldUrlEntitiyUrl fromDict:dict] copy];
    }
