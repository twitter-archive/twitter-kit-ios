 ...
 *  HTTP methods.
 */
@property (nonatomic, readonly) TwitterNetworking *networkingClient;
 ...
 *
 *  @warning This should only be changed when used in combination with -[Twitter logInWithCompletion:]
 *  and [Twitter logOut]; for backwards compatibility.
 */
