...
typedef NS_ENUM(NSUInteger, TWTRSEURLAttachmentLoadState) {
    TWTRSEURLAttachmentLoadStatePending = 1,
    TWTRSEURLAttachmentLoadStateLoading,
    TWTRSEURLAttachmentLoadStateFinishedLoading
};
