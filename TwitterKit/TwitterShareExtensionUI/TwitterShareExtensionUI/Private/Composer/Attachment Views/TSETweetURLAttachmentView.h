...
@class TSETweetAttachmentURL;
@class UILabel;
@protocol TSENetworking;


FOUNDATION_EXTERN const CGFloat TSETweetURLAttachmentViewPreferredViewHeight;
...
- (instancetype)initWithURLAttachment:(TSETweetAttachmentURL *)attachment NS_DESIGNATED_INITIALIZER;
