...
@interface TSETweetImageAttachmentView ()

@property (nonatomic, readonly) UIImageView *imageView;

@end

@implementation TSETweetImageAttachmentView

- (instancetype)initWithImageAttachment:(TSETweetAttachmentImage *)imageAttachment
{
