...
const CGFloat TSETweetURLAttachmentViewPreferredViewHeight = 80.0;
...
typedef NS_ENUM(NSUInteger, TSEURLAttachmentLoadState) {
    TSEURLAttachmentLoadStatePending = 1,
    TSEURLAttachmentLoadStateLoading,
    TSEURLAttachmentLoadStateFinishedLoading
};


#pragma mark -

@interface TSETweetURLAttachmentView ()
...
@implementation TSETweetURLAttachmentView

- (instancetype)initWithURLAttachment:(TSETweetAttachmentURL *)attachment
{
    ...
    if ((self = [super initWithFrame:CGRectZero])) {
        ...
        _linkTitleLabel.font = [TSEFonts cardTitleFont];
        _linkDomainLabel.font = [TSEFonts cardSubtitleFont];

        _linkTitleLabel.textColor = [TSEFonts cardTitleColor];
        _linkDomainLabel.textColor = [TSEFonts cardSubtitleColor];
        ...
        _linkPreviewImageView.backgroundColor = TSEUITwitterColorImagePlaceholder();
    }
...
{
    return CGSizeMake(UIViewNoIntrinsicMetric, TSETweetURLAttachmentViewPreferredViewHeight);
}
...
- (void)setUpConstraints
{
    ...
    [self.linkPreviewImageView.heightAnchor constraintEqualToConstant:TSETweetURLAttachmentViewPreferredViewHeight].active = YES;
    [self.linkPreviewImageView.widthAnchor constraintEqualToConstant:TSETweetURLAttachmentViewPreferredViewHeight].active = YES;
