...
@class TSETweetAttachmentCustomCardViewProvider;
...
- (instancetype)initWithCustomCardAttachment:(id<TSETweetAttachmentCustomCardViewProvider>)customCardAttachment;
