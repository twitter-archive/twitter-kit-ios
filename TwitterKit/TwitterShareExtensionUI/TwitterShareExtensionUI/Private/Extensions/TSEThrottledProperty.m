...
@interface TSEThrottledProperty ()
...
@implementation TSEThrottledProperty

- (instancetype)initWithThottleInterval:(NSTimeInterval)throttleInterval observer:(nonnull id<TSEThrottledPropertyObserver>)observer
{
