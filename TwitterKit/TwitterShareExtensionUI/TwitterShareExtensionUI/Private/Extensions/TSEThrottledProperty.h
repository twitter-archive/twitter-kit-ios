...
- (void)throttledProperty:(TSEThrottledProperty *)throttledProperty didChangeValue:(nullable id)lastValue;
 ...
 */
@interface TSEThrottledProperty<T> : NSObject
 ...
 */
- (instancetype)initWithThottleInterval:(NSTimeInterval)throttleInterval observer:(id<TSEThrottledPropertyObserver>)observer;

@property (nonatomic, weak, nullable) id<TSEThrottledPropertyObserver> observer;
