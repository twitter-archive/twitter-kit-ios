...
static NSBundle *_TSEUIBundle()
{
    ...
    dispatch_once(&onceToken, ^{
        sTSEUIBundle = [NSBundle bundleForClass:[TSEUIBundle class]];
#if TSEUI_STATIC_LIBRARY
...
#else
        NSCAssert([@"FMWK" isEqualToString:sTSEUIBundle.infoDictionary[@"CFBundlePackageType"]], nil);
#endif
    });
