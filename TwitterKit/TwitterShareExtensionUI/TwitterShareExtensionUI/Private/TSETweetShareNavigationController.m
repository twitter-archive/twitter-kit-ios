...
@implementation TSETweetShareNavigationController

+ (void)initialize
{
    if (self == [TSETweetShareNavigationController class]) {
        ...
        navBarAppearance.tintColor = [TSEFonts navigationButtonColor]; // access to TSEFonts is why this is in +initialize now vs +load
    }
}
