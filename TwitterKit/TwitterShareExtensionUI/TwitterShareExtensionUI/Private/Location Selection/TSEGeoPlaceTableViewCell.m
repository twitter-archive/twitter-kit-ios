...
@interface TSEGeoPlaceTableViewCell ()
...
@implementation TSEGeoPlaceTableViewCell
...
- (instancetype)init
{
    if ((self = [super init])) {
        ...
        _placeNameLabel.font = TSEFonts.placeNameFont;
        _placeAddressLabel.font = TSEFonts.placeAddressFont;
...
- (void)setUpConstraints
{
    ...
    CGFloat labelsContainerViewHeight = ([TSEFonts placeNameFont].pointSize + [TSEFonts placeAddressFont].pointSize) * kLabelVerticalMultiplier;
...
- (void)configureWithPlace:(id<TSEGeoPlace>)place selected:(BOOL)selected
{
