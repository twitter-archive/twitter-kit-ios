...
#import "TSETweet.h"
#import "TSEWordRangeCalculator.h"
...
@interface NSString () <TSEWordRangeCalculator>
@end

@implementation TSEAutoCompletionViewModel
...
- (NSString *)wordAroundSelectedLocation:(NSUInteger)selectedLocation inText:(NSString<TSEWordRangeCalculator> *)text
{
...
- (NSString *)insertAutoCompletionWord:(NSString *)word inWordAtLocation:(NSUInteger)wordLocation inText:(NSString<TSEWordRangeCalculator> *)text insertionEndLocation:(NSUInteger *)insertionEndLocation
{
    NSParameterAssert([text respondsToSelector:@selector(wordRangeIncludingUnderscoreForIndex:)]);
...
@implementation NSString (TSEAutoCompletionViewModel)
...
- (NSString *)stringForTwitterTextEntityIntersectingRange:(NSRange)range
{
    NSArray<TwitterTextEntity *> *entities = [[TSETweet twitterText] entitiesInText:self];
