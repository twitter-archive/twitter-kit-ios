...
@property (nonatomic, nullable) id<TSETweetAttachment> attachment;
@property (nonatomic, nullable) id<TSEGeoPlace> place;
...
/**
 ...
 @param attachment (Optional): See specific implementations of the `TSETweetAttachment` protocol.
 ...
 */
- (instancetype)initWithInReplyToTweetID:(nullable NSNumber *)inReplyToTweetID text:(nullable NSString *)text attachment:(nullable id<TSETweetAttachment>)attachment place:(nullable id<TSEGeoPlace>)place usernames:(nullable NSArray<NSString *> *)usernames hashtags:(nullable NSArray<NSString *> *)hashtags NS_DESIGNATED_INITIALIZER;
