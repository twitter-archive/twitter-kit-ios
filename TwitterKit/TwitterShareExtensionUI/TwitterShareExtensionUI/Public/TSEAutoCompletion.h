...
typedef void(^TSEHashtagAutoCompletionCallback)(NSArray<NSString *> * _Nullable results, NSError * _Nullable error);
typedef void(^TSEUserAutoCompletionCallback)(NSArray<id<TSETwitterUser>> * _Nullable results, NSError * _Nullable error);
 ...
 */
@protocol TSEAutoCompletion <NSObject>
 ...
 */
- (void)loadAutoCompletionResultsForHashtag:(NSString *)hashtag callback:(TSEHashtagAutoCompletionCallback)callback;
 ...
 */
- (void)loadAutoCompletionResultsForUsername:(NSString *)username callback:(TSEUserAutoCompletionCallback)callback;
