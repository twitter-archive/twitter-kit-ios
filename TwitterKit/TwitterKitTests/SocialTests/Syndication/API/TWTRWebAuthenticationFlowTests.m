...
+ (void)setUp
{
    ...
    [[Twitter sharedInstance] startWithConsumerKey:@"xK8du" consumerSecret:@"secret"];
}
...
- (void)setUp
{
    ...
    self.webAuthFlow = [[TWTRWebAuthenticationFlow alloc] initWithSessionStore:[Twitter sharedInstance].sessionStore];
}
