...
@property (nonatomic, readonly) TwitterUserAPIClient *userAPIClient;
...
- (void)setUp
{
    ...
    _userAPIClient = [[TwitterUserAPIClient alloc] initWithAuthConfig:[[TWTRAuthConfig alloc] initWithConsumerKey:@"consumerKey" consumerSecret:@"consumerSecret"] authToken:@"authToken" authTokenSecret:@"authTokenSecret"];
}

- (void)testGet
{
    NSURLRequest *getReq = [self.userAPIClient URLRequestWithMethod:@"GET" URL:@"https://google.com" parameters:@{ @"2": @"4 5" }];
...
- (void)testPost
{
    NSURLRequest *postReq = [self.userAPIClient URLRequestWithMethod:@"POST" URL:@"https://google.com" parameters:@{ @"2": @"4 5" }];
...
- (void)testDelete
{
    NSURLRequest *deleteReq = [self.userAPIClient URLRequestWithMethod:@"DELETE" URL:@"https://google.com" parameters:@{ @"2": @"4 5" }];
    NSString *expectedURL = @"https://google.com";
    NSString *expectedParams = @"2=4%205";
