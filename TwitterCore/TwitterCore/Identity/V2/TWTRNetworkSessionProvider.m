...
+ (nullable TWTRSession *)userSessionWithAuthToken:(NSString *)authToken authTokenSecret:(NSString *)authTokenSecret fromResponseData:(NSData *)responseData
{
    ...
    if (jsonError) {
        ...
        NSString *const userID = [TWTRDictUtil stringFromNumberForKey:@"id" fromDict:json].copy;
        NSString *const userName = [TWTRDictUtil stringForKey:@"screen_name" fromDict:json].copy;
