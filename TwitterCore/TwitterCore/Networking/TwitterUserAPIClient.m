...
#import "TwitterUserAPIClient.h"
#import <TwitterCore/TWTRAssertionMacros.h>
#import <TwitterCore/TWTRAuthConfig.h>
#import "TWTRGCOAuth.h"

@interface TwitterUserAPIClient ()
...
@implementation TwitterUserAPIClient
...
- (NSURLRequest *)GET:(NSString *)URLString parameters:(NSDictionary *)parameters
{
    ...
    return [TWTRGCOAuth URLRequestForPath:[originalURL path] GETParameters:parameters scheme:@"https" host:[TwitterUserAPIClient hostWithPortFromURL:originalURL] consumerKey:self.authConfig.consumerKey consumerSecret:self.authConfig.consumerSecret accessToken:[self authToken] tokenSecret:[self authTokenSecret]];
}
...
- (NSURLRequest *)POST:(NSString *)URLString parameters:(NSDictionary *)parameters
{
    ...
    NSURL *originalURL = [NSURL URLWithString:URLString];
    return [TWTRGCOAuth URLRequestForPath:[originalURL path] POSTParameters:parameters scheme:@"https" host:[TwitterUserAPIClient hostWithPortFromURL:originalURL] consumerKey:self.authConfig.consumerKey consumerSecret:self.authConfig.consumerSecret accessToken:[self authToken] tokenSecret:[self authTokenSecret]];
}
...
- (NSURLRequest *)DELETE:(NSString *)URLString parameters:(NSDictionary *)parameters
{
    ...
    NSURL *originalURL = [NSURL URLWithString:URLString];
    return [TWTRGCOAuth URLRequestForPath:[originalURL path] DELETEParameters:parameters scheme:@"https" host:[TwitterUserAPIClient hostWithPortFromURL:originalURL] consumerKey:self.authConfig.consumerKey consumerSecret:self.authConfig.consumerSecret accessToken:[self authToken] tokenSecret:[self authTokenSecret]];
}
