...
@implementation TwitterNetworking
...
{
    return [self URLRequestWithMethod:@"GET" URL:URLString parameters:parameters];
}

- (NSURLRequest *)POST:(NSString *)URLString parameters:(NSDictionary *)parameters
{
    return [self URLRequestWithMethod:@"POST" URL:URLString parameters:parameters];
}

- (NSURLRequest *)DELETE:(NSString *)URLString parameters:(NSDictionary *)parameters
{
    return [self URLRequestWithMethod:@"DELETE" URL:URLString parameters:parameters];
}
...
- (void)sendAsynchronousRequest:(NSURLRequest *)request completion:(TWTRTwitterNetworkCompletion)completion
{
    ...
    NSURLSession *session = [TwitterNetworking URLSession];
...
{
    NSMutableDictionary *headers = [@{TWTRNetworkingUserAgentHeaderKey: [TWTRResourcesUtil userAgentFromKitBundle]} mutableCopy];
